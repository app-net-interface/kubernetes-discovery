...
Please understand that *Kubernetes discovery* may receive heavy modifications with potentially breaking changes on
future versions.
...
[OWNERS](https://github.com/app-net-interface/kubernetes-discovery/blob/main/OWNERS) to discuss the
