...
Thank you for your interest in contributing to Kubernetes discovery! Please
...
[issues list](https://github.com/app-net-interface/kubernetes-discovery/issues).
...
We welcome anyone that wants to contribute to kubernetes-discovery to triage and
...
- Review existing pull requests, and testing patches against real existing
  applications that use kubernetes-discovery.
